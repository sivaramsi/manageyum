...
function getMessages() {
    // for (var e = document['getElementsByClassName']('unread'), t = 0, n = 0; n < e['length']; n++) {
    //     0 == e[n]['querySelectorAll']('.icon-muted')['length'] && t++
    // };
    var t = 0;
    var element = document.getElementsByClassName('activityFeedLabelUnseen_1JGYk')[0];
    if(element){
...
producthunt = {
    init: function(serviceConfig) {
        ...
        initIpcListener();
        console.log("producthunt preloader initialized");
    }
}
