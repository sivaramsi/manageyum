...
function getMessages() {
    var e = document['getElementsByClassName']('im_dialogs_search_field');
    if (e && '' == e[0]['value']) {
        for (var t = document['getElementsByClassName']('im_dialog_badge'), n = 0, r = 0; r < t['length']; r++) {
            0 != t[r]['innerHTML'] && n++
        };
...
function initNotificationProxy() {
    ...
    Notification = function(title, options) {
        ...
        if ((service === null || service.showNotifications) && globalNotification) {
            ...
            newOptions.icon = "https://telegram.org/img/t_logo.png";
...
telegram = {
    init: function(serviceConfig) {
        ...
        initIpcListener();
        console.log("telegram preloader initialized");
    }
}
