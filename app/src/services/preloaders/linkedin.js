...
function getMessages() {
    var e = 0,
        t = document['querySelectorAll']('.mark-as-read');

    if (t.length == 0) {
        var element = document['querySelector']('#header-messages-count');
        element != null ? element.innerHTML : 0;
    } else {
        []['forEach']['call'](t, function(t) {
            'disabled' === t['getAttribute']('disabled') || t['classList']['contains']('dropdown-item') || e++
        });
    }
...
linkedin = {
    init: function(serviceConfig) {
        ...
        initIpcListener();
        console.log("linkedin preloader initialized");
    }
}
