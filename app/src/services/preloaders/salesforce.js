...
function getMessages() {
    ...
    var unreadBadge = document.getElementsByClassName('counterLabel');
    var count = 0;

    if (unreadBadge && unreadBadge.length > 0) {
        count = parseInt(unreadBadge[0].innerHTML);
    }
...
salesforce = {
    init: function(serviceConfig) {
        ...
        initIpcListener();
        console.log("salesforce preloader initialized");
    }
}
